-- case 1:
--Query 1: Build a query that will answer - What was the total count of confirmed cases on Apr 15, 2020? 
...
--case 2:
--Query 2: Build a query for answering - How many states in the US had more than 100 deaths on Apr 10, 2020? 
...
--case 3:
--Query 3: Build a query that will answer - List all the states in the United States of America that had more than 1000 confirmed cases on Apr 10, 2020? 
...
--case 4:
--Query 4: Build a query for answering - What was the case-fatality ratio in Italy for the month of April 2020? Case-fatality ratio here is defined as (total deaths / total confirmed cases) * 100. 
...
--case 6:
--Query 6: The following query is written to identify the number of days in India between 21 Feb 2020 and 15 March 2020 when there were zero increases in the number of confirmed cases. 
...
--case 7:
--Query 7: Using the previous query as a template, write a query to find out the dates on which the confirmed cases increased by more than 10% compared to the previous day (indicating a doubling rate of ~ 7 days)in the US between the dates March 22, 2020 and April 20, 2020. 
...
--case 9:
--Query 9: The following query is trying to calculate the CDGR on May 10, 2020(Cumulative Daily Growth Rate) for France since the day the first case was reported. 
--The first case was reported on Jan 24, 2020. The CDGR is calculated as:
